...
class Kabuto extends Humanoid implements Enemy{
	...
	public static function getEnemyType(){
		return EnemyRegister::TYPE_KABUTO;
	}
	...
	public static function summon($level, $x, $y, $z){
		$nbt = new CompoundTag("", [
			...
			"Skin" => new CompoundTag("Skin", [
				new StringTag("Data", EnemyRegister::loadSkinData('Kabuto')),
				new StringTag("Name", 'ChineseMythology_ChineseMythologyDemonBanditGoldenHorn')
			]),
		]);
