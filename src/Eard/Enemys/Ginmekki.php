...
class Ginmekki extends Humanoid implements Enemy{
		...
		*/
		return [
			...
			*/
			...
			[5, 3,
				[
					[Item::IRON_NUGGET, 0, 4],
					[Item::IRON_INGOT, 0, 1],
				],
			],
			[3, 3,
				[
					[Item::IRON_NUGGET, 0, 5],
					[Item::IRON_INGOT, 0, 1],
				],
			],
			[2, 1,
	...
	public static function summon($level, $x, $y, $z){
		$nbt = new CompoundTag("", [
			...
			"Skin" => new CompoundTag("Skin", [
				...
				new StringTag("Data", EnemyRegister::loadSkinData('Ginmekki')),
