	...
	public static function summon($level, $x, $y, $z){
		$nbt = new CompoundTag("", [
			...
			"Skin" => new CompoundTag("Skin", [
				new StringTag("geometryData", EnemyRegister::loadModelData('kuwagata')),
				new StringTag("geometryName", 'geometry.MagicTheGathering.NicolBolas'),
